...
public record PostCatalogStepCommandsRequest() : HttpWorkflowRequest<CatalogStepCommandSuccess[]>("postCatalogStepCommands")
{
...
public class PostCatalogStepCommandsStep : HttpStep<PostCatalogStepCommandsRequest, CatalogStepCommandSuccess[]>
{
    public override HttpMethod Method => HttpMethod.Post;
    public override string     Path   => "/catalog-steps/commands";
...
public class GetCatalogStepStep : HttpStep<GetCatalogStepRequest, CatalogStepResponse>
{
    public override HttpMethod Method => HttpMethod.Get;
    public override string     Path   => "/catalog-steps/{id}";
}

// ── GET /catalog-steps ────────────────────────────────────────────────────────

public record ListCatalogStepsRequest() : HttpWorkflowRequest<CatalogStepResponse[]>("listCatalogSteps")
{
    public IFieldValue<string> CatalogId    { get; init; } = From(ctx => ctx.Get<CreateCatalogOutput>("CreateCatalogCommand").Id);
    public IFieldValue<string> ShowArchived { get; init; } = Static("false");
}

public class ListCatalogStepsStep : HttpStep<ListCatalogStepsRequest, CatalogStepResponse[]>
{
    public override HttpMethod Method => HttpMethod.Get;
    public override string     Path   => "/catalog-steps";
